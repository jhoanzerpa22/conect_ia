...
interface SearchResult {
  installations: InstallationsModel[];
  total: number;
}
...
function sort(installations: InstallationsModel[], column: SortColumn, direction: string): InstallationsModel[] {
  if (direction === '' || column === '') {
...
function matches(installation: InstallationsModel, term: string, pipe: PipeTransform) {
...
export class InstallationsService {
  ...
  private _installations$ = new BehaviorSubject<InstallationsModel[]>([]);
