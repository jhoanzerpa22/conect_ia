...
function sort(installations: InstallationsTypeModel[], column: SortColumn, direction: string): InstallationsTypeModel[] {
  if (direction === '' || column === '') {
...
export class InstallationsService {
  ...
  private _installations$ = new BehaviorSubject<InstallationsTypeModel[]>([]);
