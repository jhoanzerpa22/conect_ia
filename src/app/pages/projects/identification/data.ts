...
const normasListWidgets = [
  {
    id: 1,
    nombre: 'Slack brand logo design',
    descripcion: 'Create a Brand logo design for a velzon admin.',
    monitoreo: false,
    reportes: false,
    permiso: false,
    articulos: [],
...
export { statData, ActiveProjects, MyTask, TeamMembers, normasListWidgets };